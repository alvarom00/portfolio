...
const resources = {
  en: {
    translation: {
      hero: {
        greeting: "Hi, I'm",
        description: "Full-Stack Web Developer & Unreal Engine Developer crafting immersive digital experiences — from dynamic web apps to real-time 3D worlds.",
        scroll: "Scroll",
      },
      navbar: {
        home: "Home",
      ...
      about: {
        ...
        body1: "I'm a Full-Stack Web Developer and Unreal Engine Developer with a passion for creating immersive digital experiences. My journey in web development began with a fascination for crafting dynamic web applications, and it has since evolved into a love for building real-time 3D worlds.",
        body2: "With a strong foundation in both front-end and back-end technologies, I thrive on the challenge of bringing ideas to life through code. Whether it's designing intuitive user interfaces or optimizing server-side performance, I approach each project with creativity and dedication.",
        button: "Contact Me",
        cardTitle1: "Software Development",
        cardTitle2: "UI/UX & Interaction Design",
        cardTitle3: "Game Development & Real-Time Systems",
        cardBody1: "Building responsive web apps, scalable backend systems, and immersive real-time applications using modern technologies.",
        cardBody2: "Crafting user-friendly interfaces and engaging interactions that enhance the overall user experience.",
        cardBody3: "Creating immersive experiences using Unreal Engine, combining C++ and Blueprint systems to build responsive gameplay, AI behaviors, and interactive environments.",
      },
      skills: {
        title1: "My",
        title2: "Skills",
      ...
      resume: {
        ...
        educationTitle2: "Postgraduate Certificate in Video Game Programming with Unreal Engine",
  ...
  es: {
    translation: {
      hero: {
      greeting: "Hola, soy",
      description: "Desarrollador Web Full-Stack y Desarrollador de Unreal Engine creando experiencias digitales inmersivas — desde aplicaciones web dinámicas hasta mundos 3D en tiempo real.",
      scroll: "Desplázate",
      },
      navbar: {
        home: "Inicio",
      ...
      about: {
        ...
        body1: "Soy un Desarrollador Web Full-Stack y Desarrollador de Unreal Engine con una pasión por crear experiencias digitales inmersivas. Mi viaje en el desarrollo web comenzó con una fascinación por crear aplicaciones web dinámicas, y desde entonces ha evolucionado hacia un amor por construir mundos 3D en tiempo real.",
        body2: "Con una sólida base en tecnologías tanto de front-end como de back-end, disfruto del desafío de dar vida a las ideas a través del código. Ya sea diseñando interfaces de usuario intuitivas o optimizando el rendimiento del servidor, abordo cada proyecto con creatividad y dedicación.",
        button: "Contáctame",
      ...
      resume: {
        ...
        educationTitle2: "Certificado de Posgrado en Programación de Videojuegos con Unreal Engine",
