                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-semibold text-lg">{t("about.cardTitle1")}</h4>
                                    <p className="text-muted-foreground">
                                        {t("about.cardBody1")}
                                    </p>
                                </div>
                        ...
                        <div className="gradient-border p-6 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-semibold text-lg">{t("about.cardTitle2")}</h4>
                                    <p className="text-muted-foreground">
                                        {t("about.cardBody2")}
                                    </p>
                                </div>
                        ...
                        <div className="gradient-border p-6 card-hover"><div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    <h4 className="font-semibold text-lg">{t("about.cardTitle3")}</h4>
                                    <p className="text-muted-foreground">
                                        {t("about.cardBody3")}
                                    </p>
                                </div>
